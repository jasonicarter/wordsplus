...
//global - to be accessed from WordsPlusFree to set awards
...
WordsPlusFree::WordsPlusFree(bb::platform::bbm::Context &context, QObject *parent) :
		QObject(parent), m_context(&context)

//WordsPlusFree::WordsPlusFree(QObject *parent)
//    : QObject(parent)
{
	//set default values
	deltaX = 0.0;
...
WordsPlusFree::~WordsPlusFree() {
	// Destroy the sound manager.
	delete mSoundManager;
}

void WordsPlusFree::show() {
...
void WordsPlusFree::onThumbnail() {
	stopTimer();
	continuousGameAward = 0;
...
void WordsPlusFree::onFullscreen() {
	startTimer();
}

void WordsPlusFree::onOrientationChanged() {
...
/****SCORELOOP*****/
void WordsPlusFree::scoreLoopLoaded(AppData_t *data) {
	mAppData = data;
}

void WordsPlusFree::onSubmitScoreCompleted(ScoreData_t *scoreData) {
	mLastScoreData = scoreData;
	emit(submitScoreCompleted());
}

void WordsPlusFree::submitScore(int score) {
	if (Global::instance()->getIsInternetAvailable()) {
		ScoreLoopThread::SubmitScore(mAppData, score, 0);
	}
}

void WordsPlusFree::onLoadLeaderboardCompleted(QVariantList data) {
	if(data.count() == 1){
...
void WordsPlusFree::loadLeaderboard(bool includeBuddyList) {
	LOG("loadLeaderboard")
	if (Global::instance()->getIsInternetAvailable()) {
...
void WordsPlusFree::loadLeaderboardAroundLastScore() {
	if (Global::instance()->getIsInternetAvailable()) {
...
void WordsPlusFree::loadLeaderboardAroundUser() {
	if (Global::instance()->getIsInternetAvailable()) {
...
void WordsPlusFree::LoadAchievementsAwards() {
	if (Global::instance()->getIsInternetAvailable()) {
		ScoreLoopThread::LoadAchievements(mAppData);
	}
}

void WordsPlusFree::ProcessAwards() {
//TODO
...
void WordsPlusFree::onAchievedAward() {
	achievedAward = 1;
	emit achievedAwardChanged();
}

int WordsPlusFree::getAchievedAward() {
	return achievedAward;
}

ScoreLoopThread* WordsPlusFree::scoreLoop() {
	return ScoreLoopThread::instance();
}
/****SCORELOOP*****/

void WordsPlusFree::InitializeHomePage() {
...
void WordsPlusFree::InitializePuzzlePage() {
...
void WordsPlusFree::intializePlayArea() {
...
void WordsPlusFree::onTileTouch(bb::cascades::TouchEvent *event) {
...
bool WordsPlusFree::isHighlighted(int pos) {
...
void WordsPlusFree::HighlightSelectedTile(int pos, int stateOfLetter) {
...
void WordsPlusFree::WordCompleted(QList<int> listOfNumbers) {
//TODO comment out
//	ProcessAwards();
...
void WordsPlusFree::CrossOutPuzzleWord(QString wordFound) {
...
void WordsPlusFree::showToast(QString msg) {

	emit mainSysToastSignal(msg);
}

void WordsPlusFree::onTick() {
	timeSec++;
...
QString WordsPlusFree::getTheme() {
	return settings->getValueFor(THEME, "wordsPlus");
}

void WordsPlusFree::setTheme(const QString themeName) {
	settings->saveValueFor(THEME, themeName);
	emit themeChanged();
}

QString WordsPlusFree::getCategory() {
	m_strCategory = settings->getValueFor(CATEGORY, "WEATHER");
	return m_strCategory;
}

void WordsPlusFree::setCategory(const QString cat) {
	m_strCategory = cat;
	settings->saveValueFor(CATEGORY, m_strCategory);
	emit categoryChanged(m_strCategory);
}

QString WordsPlusFree::getTime() {
	return m_strTime;
}

QString WordsPlusFree::getTotalWordsFound() {
	return settings->getValueFor(WORDSFOUND, "0");
}

void WordsPlusFree::playSound(const QString msg) {
...
void WordsPlusFree::setSound(bool status) {
...
void WordsPlusFree::setMusic(bool status) {
...
bool WordsPlusFree::getProfileBox() {
	bool okProfile;
...
void WordsPlusFree::setProfileBox(bool status) {
...
QString WordsPlusFree::getPuzzleCompletedTime() {
...
QString WordsPlusFree::getLastPuzzleTime() {
...
void WordsPlusFree::SaveBestPuzzleTime(int puzzleTime) {
...
void WordsPlusFree::setScore(int puzzleTime) {
//TODO
	int score = getScore();
...
int WordsPlusFree::getGamesPlayed() {
...
void WordsPlusFree::setGamesPlayed() {
...
void WordsPlusFree::setSelectedLetters(QString letter) {
...
QString WordsPlusFree::getSelectedLetters() {
...
void WordsPlusFree::setDifficulty(int difficulty) {
...
void WordsPlusFree::Share(QString target, QString section) {
...
void WordsPlusFree::onArmed() {
	  m_pInvocation->trigger("bb.action.SHARE");
}

void WordsPlusFree::ControlsForBBM(int state) {
