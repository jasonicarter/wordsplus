...
#ifndef WordsPlusFree_HPP_
#define WordsPlusFree_HPP_
 ...
 */
class WordsPlusFree : public QObject
{
    Q_OBJECT
public:
    WordsPlusFree(bb::platform::bbm::Context &context, QObject *parent = 0);
    //WordsPlusGame(QObject *parent = 0);
	virtual ~WordsPlusFree();
