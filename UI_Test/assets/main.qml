                ...
                Container {
                    ...
                    Container {
                        ...
                        DropDown {
                            ...
                            Option {
                                id: hard
                                //imageSource: "asset:///images/68x68_v3.png"
                                text: "Hard"
                        ...
                        onCreationCompleted: {
                            ...
                            if (wordsPlus.difficulty == settingsEasy) diffDropDown.setSelectedOption(easy);
                            if (wordsPlus.difficulty == settingMedium) diffDropDown.setSelectedOption(medium);
                            if (wordsPlus.difficulty == settingHard) diffDropDown.setSelectedOption(hard);
                        }
                    } //diff buttons
                    Divider {
                        opacity: 0
